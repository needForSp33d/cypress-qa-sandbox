...
const url = 'https://booking.eastmidlandsairport.com/lounges/dates/'

//TODO: can this be ripped out?
describe('EMA - Escape Lounge - Content Check', () => {
  beforeEach(() => {
      cy.visit(url)
...
describe('EMA - Escape Lounge - E2E Check', () => {
